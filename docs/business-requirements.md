...
The platform competes directly with Craigslist as its north star. Facebook Marketplace is a UX reference only — its modern listing experience and in-app messaging are borrowed, its social network infrastructure is entirely rejected.
